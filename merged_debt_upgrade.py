...
with pd.ExcelWriter('C:/Users/beegi/OneDrive/Spring_courses/Capital_flow/countries_upgrade_debt.xlsx', engine='openpyxl', mode='a') as writer:
...
merged_df = pd.concat([Ukraine, Turkey, Thailand, SriLanka, SouthAfrica, Slovenia, Slovakia, Romania, Poland, Philippines, Pakistan, Mongolia, Mexico, Malaysia, Lithuania, Lebanon, Latvia, Korea, India, Hungary, Estonia, Czech, China, Chile, Bulgaria, Brazil], axis=1)
...
with pd.ExcelWriter('C:/Users/beegi/OneDrive/Spring_courses/Capital_flow/Eventstudy_0312.xlsx', engine='openpyxl', mode='a') as writer:
    merged_df.to_excel(writer, sheet_name='merged_debt_upgrade', index=False)